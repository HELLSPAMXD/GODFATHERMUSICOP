...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("WAJAH_U_HO")
                await self.one.join_chat("MY_GC_LINKS")
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("WAJAH_U_HO")
                await self.two.join_chat("MY_GC_LINKS")
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("WAJAH_U_HO")
                await self.three.join_chat("MY_GC_LINKS")
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("WAJAH_U_HO")
                await self.four.join_chat("MY_GC_LINKS")
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("WAJAH_U_HO")
                await self.five.join_chat("MY_GC_LINKS")
